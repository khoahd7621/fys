    ...
    C360.647,451.083,349.251,457.661,338.164,454.689z"
      ...
      s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-9xl font-bold tracking-widest my-4">404</h1>
          <h2 className="text-4xl font-medium mt-8 mb-4">UH OH! You're lost.</h2>
          ...
          <Link
            ...
            className="block max-w-[200px] text-center mt-6 px-14 py-2 bg-white border-2 border-black rounded-full font-semibold hover:bg-black hover:text-white"
          >
            HOME
          </Link>
        </div>
