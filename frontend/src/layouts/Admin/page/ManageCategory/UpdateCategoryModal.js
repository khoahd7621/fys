...
import { putUpdateCategories } from '~/services/admin/categoryService';

const UpdateCategoryModal = ({ show, setShow, data, setData, fetchList }) => {
          ...
          <div className="relative p-4 w-full max-w-2xl h-auto">
            <div className="relative bg-white rounded-lg shadow">
              ...
              <div className="p-6 flex flex-col">
                <div className="mb-6">
                  <label htmlFor="category-name" className="block mb-2 text-base font-medium text-gray-900 ">
                    Name:
                  </label>
                  <input
                    ref={inputRef}
